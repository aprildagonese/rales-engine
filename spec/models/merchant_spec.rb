...
RSpec.describe Merchant, type: :model do
  describe "Class Methods" do
    before :each do
      ...
      @item7, @item8, @item9 = create_list(:item, 3, merchant: @merch2)
      @item10, @item11, @item12 = create_list(:item, 3, merchant: @merch3)
      ...
      @invoice4, @invoice5, @invoice6 = create_list(:invoice, 3, customer: @customer, merchant: @merch1, created_at: "2019-03-07 21:29:54 UTC")
      @invoice7, @invoice8, @invoice9 = create_list(:invoice, 3, customer: @customer, merchant: @merch2, created_at: "2019-03-08 21:29:54 UTC")
      @invoice10 = create(:invoice, customer: @customer, merchant: @merch2, created_at: "2019-03-09 21:29:54 UTC")
      @invoice11, @invoice12, @invoice13 = create_list(:invoice, 3, customer: @customer, merchant: @merch3, created_at: "2019-03-08 21:29:54 UTC")
      ...
      @inv_item9 = create(:invoice_item, invoice: @invoice9, item: @item10, quantity: 3, unit_price: 3.00, created_at: "2019-03-08 21:29:54 UTC")
      @inv_item10 = create(:invoice_item, invoice: @invoice10, item: @item10, quantity: 10, unit_price: 10.00, created_at: "2019-03-08 21:29:54 UTC")
      ...
      @inv_item13 = create(:invoice_item, invoice: @invoice13, item: @item9, quantity: 10, unit_price: 1.00, created_at: "2019-03-08 21:29:54 UTC")
    ...
    xit ".revenue" do
      expect(Merchant.revenue(@merch1).to_f).to eq(162.0)
      expect(Merchant.revenue(@merch2).to_f).to eq(75.0)
      expect(Merchant.revenue(@merch2).to_f).to eq(129.0)
    end

    xit ".revenue_by_date" do
      expect(Merchant.revenue_by_date(@merch1, @invoice4.created_at).to_f).to eq(121.0)
      expect(Merchant.revenue_by_date(@merch2, @invoice9.created_at).to_f).to eq(11.0)
    end
  end
end
